                        ...
                        <div class="delivery-time">                                                    
                                                ...
                                                <p>
                                                    ...
                                                    @php
                                                        $fullAddress = $value->address . ', ' .
                                                                    ...
                                                                    $value->state->name;
                                                    @endphp
                                                    {{ \Illuminate\Support\Str::limit($fullAddress, 40) }}                                                    
                                                </p> 
                                            </div>
                                        </div>
                                        <div class="right">                                            
                            ...
                            <div class="repeate">
                                <div class="left">
                                    ...
                                    <div class="details">
                                        <h5 class="title">Slot</h5>
                                        <a href="#" class="btn btn-primary w-100 mt-2" data-bs-toggle="modal" data-bs-target="#slot">Select time & date</a>
                            ...
                            <div class="repeate">
                                <div class="left">
                                    <div class="icon"><img src="{{ asset('front-assets/images/payment.jpeg') }}" alt="location" /></div>
                                    <div class="details">
                    ...
                    <div class="cart-summery">
                        <div class="product-title-cart">                            
                            ...
                            <div class="priceDetailsBox">
                                <button type="submit" name="action" value="remove" class="btn p-0 text-muted bulk-action">Remove All</button>                            
                                {{-- @auth                                
                            ...
                            <div class="product-repeate active-card" id="cart-item-{{ $item->rowId }}"> 
                                ...
                                <div class="photo">   
                                    @if ($item->options->image)                                    
                                        <img src="{{ asset('uploads/services/small/'.$item->options->image) }}" >
                                    @else
        ...
        @else
            <div class="card mt-4">
                <div class="card-body text-center p-4">
                    ...
                    @if (Auth::check())
                        <a href="{{ route('account.wishlist') }}" class="btn btn-outline-primary mt-4">
                            Add Items from Wishlist
                        </a>
                    @else
                        <a href="{{ route('account.login') }}" class="btn btn-outline-primary retirectBack mt-4">
                            Add Items from Wishlist
                        </a>
                    @endif
                </div>
