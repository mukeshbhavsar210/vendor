                    ...
                    @if ($vendors->isNotEmpty())
                        @foreach ($vendors as $vendor)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('vendors.edit', $vendor->id) }}">
                                            @if (!empty($vendor->image))
                                                <img src="{{ asset('uploads/vendors/logo'.$vendor->logo) }}" height="70" class="me-3 align-self-center rounded">
                                            @else
                                        ...
                                        <div class="flex-grow-1 text-truncate">
                                            <h5 class="product-title">
                                                <a href="{{ route('vendors.edit', $vendor->id) }}">{{ Str::limit($vendor->business_name, 75, '...') }} </a>
                                            </h5>
                                            <div class="small-fonts">                                                    
                                                <p class="mb-0 text-muted">{{ $vendor->user->name }}</p>
                                ...
                                <td>
                                     <div class="flex">
                                        <a href="{{ route('vendors.edit', $vendor->id ) }}" class="edit-icon">
                                            <span class="sprites"></span>
                                        </a>
                                        <a href="#" onclick="deleteVendor({{ $vendor->id }})" class="delete-icon" >
                                            <span class="sprites"></span>
                                        </a>
                                    </div>
                                </td>
...
<script>
    ...
    function deleteVendor(id){
        var url = '{{ route("vendors.delete","ID") }}'
